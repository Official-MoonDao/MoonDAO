...
| **DePrize 22** (Touchdown live) | id **22**, JB **268** (mission 14), payhook `0xD6597D665cbC74e4Da52da6af34900897A24307B`, LMSR `0xC717D9ac121E2f7882f007FA046009501Fe0B43C` (H-01 replacement; pre-fix `0x9d3b999B…826D0`), condition `0xb1c4d8775e08aabcaed68cb17645aec155a22ce35316d640a3233679dbecfa66`, teams **601/602/603/604/605/24**, oracle = deployer `0x3c5e…E011`. Race binding `shared-next-landing`. QuestionId `0x1ba1808c0a0d8a2bbc48462cd3a490e306695713e0cafd362d365c9db3f43513` (`shared-next-landing:v2`). Shareable path `/deprize/shared-next-landing`. |
