...
## What's in the deck (14 slides)

1. Title — Brazil flag on the right panel (host country of Rio Innovation Week)
...
Photos/graphics come from four places, all real (no stock imagery, nothing invented):
...
3. **The reference deck the user supplied** (`MoonDAO 101 PPT_design_improvements.pptx`)
   ...
   `assets/reference/`: a real photo of Frank White with an Earth graphic (slide 7,
   cropped from the "Send Frank to Space" campaign graphic), the real "The Overview
   Effect" book cover (slide 7), a fresh Earth-sunrise photo (slide 6 background),
   MoonDAO's official Space Acceleration Network diagram shown in full (slide 12), and
   a full screenshot of the real MoonDAO Network/citizens page (slide 13).
