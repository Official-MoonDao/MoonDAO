...
const { PROJECT_TABLE_ADDRESSES } = require("../../../../../ui/const/config.ts");
...
const privateKey = "0xda4c51a20cb325633e7459739bde3a36151337701bc0bad74b63f688133d80d7";
...
async function loadProjectData() {
    try {
        ...
        const newProposals = proposals
            .filter(proposal => !existingMDPs.has(proposal.proposalId))
