...
import V3_SWAP_ROUTER_ABI from '../abis/UniswapSwapRouter.json'
import { MOONEYToken } from './config'
...
const MOONEY = new Token(chainId, MOONEYToken, 18, 'MOONEY', 'MOONEY')
