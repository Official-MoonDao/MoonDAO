...
export default function ZeroGravity() {
  ...
  return (
    <main className="animate-fadeIn">
      ...
      <div className="mt-3 px-5 lg:px-7 xl:px-10 py-12 lg:py-14 page-border-and-color w-[336px] sm:w-[400px] lg:mt-10 lg:w-full lg:max-w-[1080px]">
        <h2 className="page-title flex">Zero Gravity</h2>
        ...
        <div className="mt-3 lg:mt-4 font-Lato">
          ...
          <iframe
            ...
            allowFullScreen
          />
          <p className="mt-6 font-Lato text-base xl:text-lg text-[#071732] dark:text-white text-opacity-70 dark:text-opacity-60">
