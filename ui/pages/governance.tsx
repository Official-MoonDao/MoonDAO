...
const Governance: React.FC = () => {
  ...
  const governanceCards = [
    ...
    },
    {
      ...
      paragraph: 'Join the MoonDAO community by acquiring our governance token $MOONEY.',
    },
    {
      icon: '/assets/icon-power.svg',
      iconAlt: 'Get Voting Power',
      header: 'Get Voting Power',
      link: '/mooney?tab=lock',
    ...
    },
    {
      ...
      link: '/mooney?tab=bridge',
      hovertext: 'Bridge $MOONEY',
      paragraph: 'Bridge $MOONEY between Ethereum and Arbitrum to reduce gas fees.',
    },
    {
      icon: '/assets/icon-wallet.svg',
