...
const Governance: React.FC = () => {
  ...
  const indexCardData = [
    {
      ...
      paragraph: (
        <>
          Export your embedded wallet to an external wallet.
        </>
      ),
      onClick: () => {
        if (isClient) {
    ...
    },
    {
      ...
      paragraph: (
        <>
          Learn how you can reduce onchain gas fees by bridging $MOONEY from L1 to L2.
        </>
      ),
      inline: true,
    },
    ...
    },
    {
      ...
      paragraph: (
        <>
          Most proposals start in our “Ideation” channel in the Discord. Post your idea there to get feedback and start the submission process!
        </>
      ),
      inline: true,
    },
  ...
  const description = "MoonDAO's Treasury is governed by its Citizens. If you don't have voting power, become a Citizen by joining our community. You can read MoonDAO's Constitution to understand more about how our governance works.";
