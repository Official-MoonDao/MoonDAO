        ...
        <div className="min-h-screen bg-dark-cool text-white w-full">
            ...
            <div className="max-w-7xl mx-auto text-center space-y-8 relative z-10 -mt-20">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                  The governance token that powers MoonDAO's mission to create a
                  self-sustaining, self-governing settlement on the Moon.
                </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-gradient-to-br from-gray-900 via-blue-900/30 to-purple-900/20 rounded-xl p-6 border border-white/10">
                  ...
                  <p className="text-gray-300 text-sm mb-3">
                    Lock MOONEY to get vMOONEY voting power. Influence =
                    √(vMOONEY balance).
                  </p>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-black/20 rounded-lg p-4">
                      ...
                      <code className="text-purple-300 text-sm break-all">
                        0x1Fa56414549BdccBB09916f61f0A5827f779a85c
                      </code>
                    </div>
                    <div className="bg-black/20 rounded-lg p-4">
                      <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-black/20 rounded-lg p-4">
                      ...
                      <div className="text-gray-300 text-sm space-y-1">
                        ...
                        <p>
                          1,000,000 vMOONEY = √1,000,000 = 1,000 voting power
                        </p>
                      </div>
                    </div>
                    <div className="bg-black/20 rounded-lg p-4">
                      ...
                      <div className="text-gray-300 text-sm">
                        <p>
                          Prevents whale dominance by limiting large holder
                          influence. Ensures democratic participation in DAO
                          governance.
                        </p>
                      </div>
                    </div>
          ...
          <section className="py-16 px-6 bg-gradient-to-br from-purple-900/30 to-blue-900/30 w-full">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Get MOONEY, lock for voting power, and help shape humanity's
                space future.
              </p>
