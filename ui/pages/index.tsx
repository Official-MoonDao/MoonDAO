      ...
      <div className="flex flex-col pt-10 w-full">
        ...
        <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <dl className="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-2 lg:gap-x-8">
            <div className="flex">
              <div className="ml-3">
                <dt className="text-lg font-RobotoMono font-medium text-center lg:text-left">Help Decentralize Access to Space</dt>
            ...
            <div className="flex">
              <div className="ml-3">
                <dt className="text-lg font-RobotoMono font-medium text-center lg:text-left">Shape Our Community’s Destiny</dt>
                <dd className="mt-5 lg:mt-4 font-RobotoMono xl:mt-6 text-sm sm:text-base lg:text-sm xl:text-base sm:mt-6 max-w-[698px] text-center lg:text-left text-gray-600 dark:text-white dark:opacity-60">
