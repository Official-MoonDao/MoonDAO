...
export default function ZeroGDetail({ slug }: any) {
  ...
  return (
    <div
      className="flex flex-col justify-center items-center text-center md:w-[80%] w-screen card rounded-[15px] border-[0.5px] border-gray-300 bg-black bg-opacity-30 shadow-indigo-40 text-white font-RobotoMono shadow-md overflow-visible p-[5%] relative right-4"
      ref={mainRef}
    >
      ...
      <div className="flex flex-col justif-center  items-center backdropBlur">
        ...
        <div className="my-8 flex flex-col gap-4 w-full">
          <p>
            {`
            The MoonDAO™ ZeroG Sweepstakes (the “Promotion”) is sponsored by
            LuckDAO Limited d/b/a MoonDAO (“Sponsor”). By entering the
            Promotion, you agree to comply with and be bound by the following
            MoonDAO™ ZeroG Sweepstakes Rules (the “Rules”). Please review the
            Rules carefully. If you do not agree to the terms and conditions of
            the Rules in their entirety, you are not permitted to enter the
            Promotion. This Promotion may be canceled or postponed by Sponsor,
            at any time in its sole discretion.`}
          </p>
          <hr></hr>

          <p className="text-2xl">ELIGIBILITY</p>
          <p>
            {`
The Promotion is open only to individuals who are eighteen (18) years of age or older (or the applicable age of majority, if greater than eighteen (18) years of age in their respective jurisdictions) and that can enter into legally binding contracts under applicable law. The Promotion is expressly void in Florida, New York, Puerto Rico and where otherwise prohibited by law. Employees, officers and directors of Sponsor, Zero Gravity Corporation (“ZeroG”), and each of the foregoing individuals’/entities’ respective parents, subsidiaries and affiliated companies, and each of their legal representatives, advertising, promotional, fulfillment and marketing agencies, and their immediate families (and those living in their respective households), are not eligible to participate or claim a Prize (as defined below) in the Promotion. Participation constitutes each entrant’s full and unconditional agreement to Sponsor’s decisions, which are final and binding in all matters related to the Promotion. Winning a Prize is contingent upon fulfilling all requirements set forth herein.`}
          </p>
          <hr></hr>
          <p className="text-2xl">LIMITED TIME ONLY</p>
          <p>
            {`
            The Promotion period (“Promotion Period”) begins at 8:00:00 a.m.
            Pacific Standard Time (“PST”) on March 14, 2023, and ends at
            11:59:00 p.m. PST on April 11, 2023 (“Promotion End Date”). Entries
            must be received prior to the expiration of the Promotion Period to
            be eligible for a Prize.`}
          </p>
          <hr></hr>
          <p className="text-2xl">HOW TO ENTER</p>
          <p>
            {`(a) vMooney Entries. Each prospective entrant wishing to enter the Promotion through the acquisition of vMooney must: (i) already have or, if not, obtain, a wallet application (“Wallet”) that is capable of holding the tokens associated with the Promotion which will be launched and stored on the Ethereum blockchain; and (ii) visit the Sponsor website located at app.moondao.com (the “Site”) and enroll during the Promotion Period. In order to complete the registration process on the ZeroG Raffle Page, each prospective entrant must: (A) provide her/his Twitter® handle and follow Sponsor’s Twitter® account (a prospective entrant may need to create a new Twitter® account where she/he does not already have one); (B) provide her/his Discord® username (a prospective entrant may need to create a new Discord® account where she/he does not already have one); (C) provide an Ethereum wallet address with on-chain proof of staking Mooney for vMooney; and (D) provide an associated email address. Each individual whose Wallet indicates ownership of vMooney through at 11:59:00 p.m. PST on June 9, 2023 (“Snapshot Date”) shall receive one (1) entry in the Promotion, up to a maximum of one (1) Raffle Entry.`}{' '}
          </p>
          <p>{`
            Discord® is a registered trademark of Discord Inc. (“Discord”). Twitter® is a registered trademark of Twitter, Inc. (“Twitter”). Please be advised that Sponsor is not in any way affiliated with Discord and/or Twitter, and the Promotion is not endorsed, administered or sponsored by Discord and/or Twitter.`}</p>

          <p
            className="rounded-md p-2"
            ref={altEntryRef}
          >{`(b) Alternative Means of Entry.** As an alternative means of entry in the Promotion, each prospective entrant may submit a mail-in entry in the form of a handwritten self-addressed, stamped envelope that contains the AMOE Registration Data, as defined below (each, an “AMOE Entry Submission”). For a properly submitted AMOE Entry Submission, the entrant shall receive one (1) one entry in the Promotion (each, an “AMOE Entry,”), up to a maximum of one (1) AMOE Entry. To complete an AMOE Entry Submission, each entrant must legibly handwrite (no typing allowed) on a piece of paper included in the AMOE Entry Submission her/his: (i) full name; (ii) mailing address; (iii) telephone number; and (iv) Wallet address (collectively, “AMOE Registration Data”). All AMOE Entry Submissions must be postmarked no earlier than March 14, 2023 and no later than April 4, 2023 to be eligible to receive an AMOE Entry. Any improperly submitted AMOE Entry Submissions (i.e., any potential AMOE Entry Submissions having invalid or incomplete AMOE Registration Data) will be VOID`}</p>
          <p>{`(c) Entry Limits/General Provisions. Each entrant’s Wallet must be maintained in good standing throughout the Promotion Period to remain eligible to receive a Prize. Entrants may not enter with more than one (1) Entry on the Snapshot Date. Any prospective entrant that owns more than one (1) Entry on the Snapshot Date will be automatically disqualified from participation in the Promotion. The total combined number of Entries obtained during the Promotion Period per entrant may not exceed one (1) in the aggregate. So, by way of example, if an entrant submits an AMOE Entry during the Promotion Period, that entrant will not be permitted to also obtain a vMooney Entry during the Promotion Period. Multiple individuals are not permitted to share the same Wallet. Any attempt by any individual to obtain more than the permitted number of Entries by using multiple/different Wallets, e-mail addresses, identities, or any other method, will void all of that individual’s Entries and that individual will be disqualified from participating in the Promotion. Use of any automated system to participate in the Promotion is prohibited and will result in disqualification. Sponsor reserves the right to reject any Entry that it believes, in its sole and reasonable discretion, is fraudulent, incomplete or otherwise invalid. Sponsor is not responsible for Entries, notifications, claims or notices that are lost, late, illegible, misdirected, damaged, incomplete or incorrect. Entrants who are potential Prize winners may be required to provide some or all of the following: (i) Social Security Number; (ii) Photo ID; and (iii) any other information requested by Sponsor in connection with the Prize verification/award process (“Prize Winner Data” and together with the Site Registration Data and AMOE Registration Data, the “Registration Data”). SPONSOR IS NOT RESPONSIBLE FOR ENTRIES, TOKENS, WALLETS, CLAIMS OR NOTICES THAT ARE LOST, LATE, ILLEGIBLE, MISDIRECTED, DAMAGED, INCOMPLETE OR INCORRECT. IF YOU FAIL TO OBTAIN AN ENTRY FOR ANY REASON WHATSOEVER, YOU WILL NOT QUALIFY FOR A PRIZE.`}</p>
          ...
          <hr></hr>
          <p className="text-2xl">IDENTIFICATION OF ENTRANTS</p>
          <p>
          ...
          <hr></hr>
          <p className="text-2xl">PRIZE DESCRIPTION</p>
          <p>
            {`(a) Grand Prize. The Grand Prize winner shall receive: (i) the opportunity to reserve a seat on an upcoming flight on the Zero Gravity Corporation’s flight chartered by Sponsor (each, a “Flight”), which intends to travel in such a way as to experience the sensation of weightlessness; (ii) a one (1) time lump sum payment of up to Five Thousand Dollars (US$5,000) to cover the actual, out of pocket costs incurred by the Grand Prize winner for two (1) roundtrip coach airplane tickets to Houston, Texas, and transportation to and from the departure airport and arrival airport if necessary (collectively, “Travel Costs”), for the Grand Prize winner and Guest (as defined below); and (iii) a lump sum payment covering the actual municipal, state and federal income taxes incurred by the Grand Prize winner (“Grand Prize Taxes”) that are directly attributable to the Grand Prize (collectively, the “Grand Prize,” and together with the Alternate Prizes, the “Prizes”). The ARV of the Grand Prize is Twenty Thousand Dollars (US$20,000.00). The Grand Prize winner will not receive the difference between the actual Prize value and the ARV.`}
          </p>
          <p>{`(b) Grand Prize Terms and Conditions. The specifics of all aforementioned elements of the Grand Prize shall be determined in the sole and exclusive discretion of ZeroG and Sponsor.  Some restrictions apply. The Grand Prize winner must provide documentation detailing the applicable Grand Prize Taxes that is satisfactory to Sponsor in its sole and reasonable discretion in order to receive reimbursement of same. The Grand Prize winner must provide documentation detailing the applicable Travel Costs that is satisfactory to Sponsor in its sole and reasonable discretion in order to receive reimbursement of same. As a condition precedent to accepting the Grand Prize, the potential Grand Prize winner must enter into a separate contract with ZeroG, including the Informed Consent document referenced therein, as well as any and all publicity waivers, health and safety waivers, waivers of claims, Non-Disclosure Agreements (“NDA”), codes of conduct and/or any other agreements, documents and/or policies required by ZeroG from time-to-time, in its sole and absolute discretion (collectively, “ZeroG Agreements”). The potential Grand Prize winner must also comply with any and all personal codes of conduct established by ZeroG, from time-to-time. The potential Grand Prize winner acknowledges and agrees that ZeroG reserves the right at any time, and in its sole discretion, to remove the potential Grand Prize winner from her/his assigned Flight for any or no reason whatsoever including, without limitation, for weight and balance constraints and/or for violation of any ZeroG Agreement(s) and/or codes of conduct. Subject to the terms of the NDA, the potential Grand Prize winner should discuss any aspects of her/his participation in the Flight with appropriate medical, legal, emergency contact, and insurance professionals as she/he deems necessary. The potential Grand Prize winner must promptly notify ZeroG of any situation that may impair or affect the potential Grand Prize winner’s ability to participate in the applicable Flight. Without limiting the foregoing, in the event the potential Grand Prize winner tests positive for COVID-19 within fourteen (14) days of the targeted Flight date, or experiences another medical condition that would prevent the potential Grand Prize winner’s participation in the Flight, the potential Grand Prize winner understands and agrees that she/he may forfeit the Grand Prize in its entirety. ZeroG shall provide the potential Grand Prize winner with familiarization and training as determined by ZeroG, in its sole discretion, to be necessary for the potential Grand Prize winner to participate in the Flight. Such familiarization and training will occur in Houston, Texas, prior to departure or in some other location that ZeroG deems appropriate. ZeroG, in its sole discretion, shall determine whether the potential Grand Prize winner has sufficiently completed all Flight-related familiarization and training in advance of the Flight. The potential Grand Prize winner shall participate in pre- and/or post-Flight media or publicity activities as reasonably requested by ZeroG and/or Sponsor. The potential Grand Prize winner understands and acknowledges that as part of the Flight, the potential Grand Prize winner may be required by ZeroG to visibly wear items or otherwise use items from ZeroG’s sponsorship partners and participate in media events related to the Flight with ZeroG’s sponsorship partners. The potential Grand Prize winner is prohibited from monetizing her/his participation in the Flight without ZeroG’s prior written consent, in each instance. Without limiting the foregoing, the potential Grand Prize winner is prohibited from advertising, promoting, wearing, displaying, or otherwise supporting the brand, logo, trademark, or recognizable marking of any other entity, corporation, person, or organization in Flight-related or ZeroG-related activities or events without the express advance written permission of ZeroG.`}</p>
          <p>{`ZeroG and Sponsor will determine flight dates for each applicable Flight in their respective sole and exclusive discretion and such flight dates may be postponed at any time by ZeroG in its sole discretion.  The potential Grand Prize winner shall arrive in the vicinity of Houston up to four (4) days in advance of the Flight launch date (“Launch Date”) and at the location specified by ZeroG. The potential Grand Prize winner may participate in post-Flight debrief activities with ZeroG or Sponsor, at ZeroG’s or its affiliates’ facilities in Texas, which debriefs may include, at ZeroG’s discretion: (i) recording of data or experiences associated with the Flight; (ii) written and/or digital surveys; and/or (iii) in-person (or over the phone) interviews.`}</p>
          <p>{`Sponsor will provide complimentary accommodations for the potential Grand Prize winner and her/his Guest. Accommodations will be located near the Flight location. ZeroG recommends that the Guest arrives one (1) day prior to the Flight Date; provided, however, that accommodations are included beginning one (1) nights prior to the Flight Date through one (1) day after the Flight Date for the potential Grand Prize winner and her/his Guest. Any guests in addition to the potential Grand Prize winner and her/his Guest are responsible for arranging, and paying, for transportation to Houston, Texas. Sponsor will provide ground transportation from those permitted arrival points to the Flight Site for the potential Grand Prize winner. The potential Grand Prize winner and her/his Guest will receive food and beverages during their stay. Beverages are defined as non-alcoholic beverages as well as beer, wine, and liquor for individuals above the legal age for alcohol consumption, all as determined by Sponsor in its sole discretion. Special food and beverage requests may be provided at an additional cost, which will be billed separately.`}</p>
          <p>{`Other than as expressly set forth above, the potential Grand Prize winner and her/his Guest are solely responsible for arranging, and paying, for transportation to and from the Flight Site, the post-Flight debrief site and/or any pre-Flight training site designated by ZeroG, as well as for any hotel accommodations required in connection with same.`}</p>
          <p>{`No refund or compensation will be made in the event of the cancellation or delay of any Flight.  The potential Grand Prize winner (and Guest, where applicable) is solely responsible for obtaining any identification documents necessary for domestic travel. The potential Grand Prize winner (and Guest, where applicable) is responsible for obtaining travel insurance (and all other forms of insurance) at her/his option and the potential Grand Prize winner hereby acknowledges that neither Sponsor nor ZeroG will obtain nor provide travel insurance or any other form of insurance. The Grand Prize is, at all times, subject to all applicable federal, state and local laws and regulations.`}</p>
          <p>{`Incidentals, tips, telephone calls and any other personal expenses incurred in connection with the Grand Prize are the responsibility of the potential Grand Prize winner.  No part of the Grand Prize is transferable or may be converted to a cash payment, resold, included in a separate promotion, or otherwise distributed to any member of the general public.`}</p>
          <hr></hr>
          <p className="text-2xl">ODDS OF WINNING A PRIZE</p>
          <p>
          ...
          <p>{`For a thorough recital of the Sponsor Privacy Policy, Click Here. To the extent that the Sponsor Privacy Policy is in conflict or inconsistent with these Rules as they pertain to the Promotion, these Rules shall take precedence.`}</p>
          <hr></hr>
          <p className="text-2xl">TAX INFORMATION</p>
          <p>{`Other than as expressly set forth above with respect to the Grand Prize Taxes, all federal, state and local taxes, and all similar fees and assessments, are the responsibility of the Prize winners. Sponsor reserves the right to withhold taxes from a winning Prize, as appropriate. Where required by law, Sponsor will issue a form 1099-MISC for the Prize winner(s) in the amount of the applicable Prize(s).`}</p>
          <hr></hr>
          <p className="text-2xl">NO SUBSTITUTION OF WINNERS</p>
          <p>{`The Raffle Entries are not transferrable, and may not be sold, under any circumstances. The Prizes are non-transferable, and no substitution or transfer of a Prize will be accommodated or permitted, other than as expressly set forth herein or in Sponsor’s sole discretion. Sponsor reserves the right to substitute a Prize, or any portion thereof, for a substitute of equal or greater value for any reason.`}</p>
          <hr></hr>
          <p className="text-2xl">PUBLICITY</p>
          ...
          <hr></hr>
          <p className="text-2xl">RELEASE</p>
          ...
          <hr></hr>
          <p className="text-2xl">DISQUALIFICATION</p>
          ...
          <hr></hr>
          <p className="text-2xl">FORCE MAJEURE EVENTS</p>
          ...
          <hr></hr>
          <p className="text-2xl">INDEMNIFICATION</p>
          ...
          <hr></hr>
          <p className="text-2xl">LEGAL WARNING</p>
