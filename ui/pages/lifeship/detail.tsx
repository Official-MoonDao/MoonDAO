  ...
  return (
    <div className="animate-fadeIn">
      ...
      <MainCard title="">
        ...
        <p className="">{`MoonDAO is partnering with lifeship to send NFTs to space! Please upload a file and complete the checkout. You will be emailed instrucitons to claim your NFT.`}</p>
