        ...
        >
          <Frame backgroundColor="#090D21">
            ...
            <p className="pb-10 md:pb-5">
              ...
              decentralizing access to space research and exploration. Be sure to enter your email
              address to learn how you can get involved and about some of the exciting stuff we've
              got in the works... Like the launch of our second astronaut!
            </p>
            <p className="pb-10 md:pb-5">
              Explore{' '}
              <u>
                <Link href="/">MoonDAO.com</Link>
              </u>
            </p>
            <ColorsAndSocials />
          </Frame>
