...
// import { vMOONEYRequiredStake, MOONEYToken } from '../lib/config'
...
//         transformNumber(
//           vMOONEYRequiredStake as unknown as number,
...
//         .gte(
//           transformNumber(
//             (vMOONEYRequiredStake as unknown as number) / 4,
//             NumberType.bignumber
//           )
//         ),
//     })
...
//                 {vMOONEYRequiredStake} $vMOONEY
//               </span>
//               . This is to make sure all citizens are economically aligned.
//               <br />
//               <br />
//               Your $MOONEY won't be taken away from you. As your lock matures,
...
//                 <div className="stat-value">{vMOONEYRequiredStake}</div>
//                 <div className="stat-desc">$vMOONEY</div>
//               </div>
...
//               <a
//                 className="btn btn-primary normal-case font-medium grow"
//                 href={`https://app.balancer.fi/#/trade/ether/${MOONEYToken}`}
