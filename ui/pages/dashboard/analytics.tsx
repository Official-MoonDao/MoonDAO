...
export default function Analytics() {
  ...
  return (
    <div className="animate-fadeIn relative">
      ...
      <div className={`${!isTreasury ? "md:ml-16" : "xl:ml-12 2xl:ml-16"} my-3 uppercase flex items-center justify-between rounded-full bg-gradient-to-r from-stronger-light to-moon-blue dark:from-amber-500 dark:to-stronger-dark py-2 px-4 w-[340px]`}>
        <p className={`text-sm tracking-wide ${!isTreasury ? "text-white font-bold" : "text-gray-300 dark:text-gray-200 font-semibold"}`}>Voting Power</p>
        {/*Toggle button*/}
        <div
        ...
        <p className={`text-sm tracking-wide ${isTreasury ? "text-white font-bold" : "text-gray-300 dark:text-gray-200 font-semibold "}`}>Treasury</p>
      </div>
