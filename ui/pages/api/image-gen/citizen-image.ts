        ...
        body: JSON.stringify({
          prompt: {
            ...
            '39': {
              inputs: {
                clip: ['4', 1],
                text: "Head-and-shoulders portrait, tightly cropped at upper chest, face and shoulders fill the frame, only head and shoulders visible, youthful person with smooth healthy clear skin, bright clear eyes with accurate natural eye color matching the reference photo exactly, precise iris color and details preserved from input image, correct eye color, realistic eye color, full hair clearly visible, ears fully visible and uncovered, smooth chin, clear forehead, confident determined gaze, heroic and powerful presence, wearing opaque futuristic clothing that fully covers chest and body, closed high-collar top with long sleeves, non-revealing conservative clothing, solid opaque fabric, no skin exposed below neck, painterly style of Jodorowsky's Dune, surreal watercolor psychedelic cosmic background, clean cinematic lighting, flattering soft key light, vivid colors, sharp focus, high quality, best flattering youthful version of the person, fully dressed, only one person",
              },
