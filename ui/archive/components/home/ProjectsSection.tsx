    ...
    <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-full opacity-10">
          <Image src="/zero-g-image.jpg" alt="Background" fill className="object-cover" />
        </div>
        {/* Geometric patterns */}
      ...
      <div className="relative z-10 container mx-auto px-5 py-16 md:py-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Contribute to groundbreaking space projects, from lunar missions to space technology
            development. Join our community-driven approach to accelerating humanity's{' '}
            <span className="text-green-400 font-semibold">multiplanetary future</span>.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 backdrop-blur-sm border border-green-500/20 rounded-2xl p-8 text-center hover:border-green-400/40 transition-all duration-300 flex flex-col h-full">
            ...
            <h3 className="text-2xl font-GoodTimes text-white mb-4">Projects</h3>
            <p className="text-gray-300 mb-6 flex-grow">
              Discover active projects and contribute your skills to earn rewards. From engineering
              to content creation, find opportunities that match your expertise.
            </p>
            <StandardButton
          ...
          <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 backdrop-blur-sm border border-purple-500/20 rounded-2xl p-8 text-center hover:border-purple-400/40 transition-all duration-300 flex flex-col h-full">
            ...
            <p className="text-gray-300 mb-6 flex-grow">
              Track project progress and submit final reports. Maintain transparency and
              accountability in our decentralized project ecosystem.
            </p>
            <StandardButton
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-xl p-6 border border-gray-600/30 hover:border-green-500/50 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Established a working makerspace in Prospera during Vitalia, hosting 25 events with
                300+ participants including tech leaders.
              </p>
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-xl p-6 border border-gray-600/30 hover:border-blue-500/50 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm mb-4">
                VIP astronaut training experiences in zero gravity with NASA astronauts like Charlie
                Duke and Doug Hurley.
              </p>
              <div className="flex justify-between items-center">
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-xl p-6 border border-gray-600/30 hover:border-purple-500/50 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Advanced research project analyzing lunar communication topologies and positioning
                systems, submitted to DARPA's LunA-10 program.
              </p>
              <div className="flex justify-between items-center">
        ...
        <div className="max-w-7xl mx-auto text-center mt-16">
          ...
          <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
            Whether you're an engineer, designer, researcher, or dreamer, there's a place for you in
            our projects.
          </p>
