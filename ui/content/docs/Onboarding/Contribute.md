...
MoonDAO Projects are non-perpetual, goal-based teams that are approved to execute autonomously. MoonDAO teams have no over-head from [MoonDAO governance](/docs/Governance/Governance-Model). 
...
The Executive Lead role is given to elected leaders that are trusted with stewarding the DAO and helping guide it as it becomes increasingly decentralized. This is the highest level of contribution to the DAO. The DAO holds annual votes to select an Executive Lead on staggered three-year terms, as detailed in our [Constitution](/docs/Governance/Constitution).
