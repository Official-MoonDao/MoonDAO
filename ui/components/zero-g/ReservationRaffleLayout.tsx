    ...
    return (
      <>
        {!loading ? (
          ...
          >
            <div
              className={`card min-w-80 md:w-full rounded border-indigo-300 border-[0.5px] bg-black bg-opacity-50  text-white font-RobotoMono shadow-md overflow-visible lg:px-3`}
            >
              <div
