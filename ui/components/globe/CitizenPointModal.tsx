      ...
      <div className="w-[90vw] max-w-[700px] rounded-2xl flex flex-col gap-5 bg-gradient-to-b from-slate-700/20 to-slate-800/30 backdrop-blur-xl border border-slate-600/30 shadow-2xl p-6 md:p-8">
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            id="close-modal"
            type="button"
            className="flex h-10 w-10 border border-slate-500/50 hover:border-slate-400/70 hover:bg-slate-600/30 items-center justify-center rounded-full focus:outline-none focus:ring-2 focus:ring-slate-400/50 transition-all hover:scale-105 flex-shrink-0"
