...
const Content: React.FC<ContentProps> = ({ titleSection, header, subHeader, description, headerSize, children }) => {
    return (
        <div>
                    ...
                    <div className="relative h-auto z-0">
                        ...
                        <section className={`flex flex-col lg:flex-row h-full relative max-w-[1200px] ${children ? " lg:items-center" : "lg:items-start " } `}>  
                            <div id="image-container" className="w-full h-full relative left-[-1px]">
                                <div id="image" className="feature-4 min-h-[200px] mb-10 md:min-h-[200px] lg:min-h-[550px] md:min-w-[350px]"> </div>
                            </div>
                            <div id="⭐ title-wrapper" className={`z-50 overfow-x-hidden min-w-[500px] pr-10 ${children ? "pb-10 md:pb-[100px] lg:pb-[200px]" : "flex md:items-start lg:items-center min-h-[60vh] lg:min-h-[90vh]"}`}>
                                <div id="title-container" className=" p-5 pr-10 lg:ml-[-8vw] w-full h-full md:max-w-[700px] lg:max-w-[100%]">
            ...
            {children && (
                <div id="main-section-container" className="mt-0 md:mt-[-100px] lg:mt-[-200px] relative w-full max-w-[1200px]">
                    <div className="m-5 md:m-10">
                        <section id="main-section" className="bg-dark-cool text-white w-full mb-0 mt-0 p-10 pb-20 rounded-[5vmax] rounded-tl-[20px] overflow-hidden min-h-[200px] lg:min-h-[400px]">
                            {children}
                        </section>
                    </div>
                </div>
