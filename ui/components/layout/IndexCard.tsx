...
export default function IndexCard({
    ...
    <span
      ...
      <span
        ...
        <span
          ...
          <div id="index-description-and-id-container" className="relative z-50 flex justify-center w-full">
            <div id="index-description-and-id" className="description text-left ">
  ...
  return (
    <span
      ...
      ></span>
      {link ? (
        <Link id="index-card-link" href={link} className="w-full h-full block">
          {cardContent}
        </Link>
      ) : metadata?.name ? (
        <button
