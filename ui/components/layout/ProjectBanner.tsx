import { PROJECT_SYSTEM_CONFIG, NEXT_QUARTER_FUNDING_USD, MAX_BUDGET_USD } from 'const/config'
...
export default function ProjectBanner() {
  ...
  const budgetDisplay = `$${Math.round(NEXT_QUARTER_FUNDING_USD).toLocaleString()}`
          ...
          <div className="marquee-container overflow-hidden">
            <div className="marquee-content">
              <span className="inline-flex items-center gap-2 sm:gap-3 whitespace-nowrap px-6 sm:px-8">
                ...
                <span className="mx-1 sm:mx-2">•</span>
                <span className="text-xs sm:text-sm text-blue-200">
                  Max per project: ${Math.round(MAX_BUDGET_USD).toLocaleString()}
                </span>
              </span>
