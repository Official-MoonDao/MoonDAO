...
const timelineEvents: TimelineEvent[] = [
  {
    ...
    description:
      'MoonDAO was officially launched as the first decentralized autonomous organization focused on space exploration and lunar settlement.',
  ...
  },
  {
    ...
    title: 'Raised $8M',
    description:
      'Successfully raised 2600 ETH through community funding and announced partnership with Blue Origin for civilian space flights. Two tickets were purchased on Blue Origin flight.',
  ...
  },
  {
    ...
    description:
      "Coby Cotton was selected and successfully launched to space on Blue Origin's flight. MoonDAO also established its foundational constitution.",
  ...
  },
  {
    ...
    description:
      'MoonDAO expanded its mission by funding 80+ space-related projects, supporting innovation in the space technology sector and fostering a thriving ecosystem of space entrepreneurs.',
  ...
  },
  {
    ...
    title: 'Space Network',
    description:
      'Launched the Space Acceleration Network to foster collaboration and accelerate space technology development.',
  ...
  },
  {
    ...
    description:
      "Eiman Jahangir was selected and successfully completed the journey to space, marking MoonDAO's second successful astronaut mission.",
    icon: '/assets/icon-astronaut.svg',
  ...
  },
  {
    ...
    title: 'Launchpad',
    description:
      'Launched the MoonDAO Launchpad platform, enabling decentralized funding for space missions and projects.',
  ...
  },
  {
    ...
    title: 'Lunar Party',
    description:
      "The first minimum viable Lunar Settlement is complete. Host a New Year's Eve party on the Moon celebrating humanity's achievement.",
                  ...
                  return (
                    ...
                    >
                      ...
                      {isLastEvent ? (
                        ...
                        <div
                          className={`relative w-16 h-16 rounded-full border-4 transition-all duration-300 flex items-center justify-center flex-shrink-0 z-30 ${
                            selectedEvent === index
