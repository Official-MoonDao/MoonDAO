...
export default function Card({ logo, alt, link, name, subtitle, isWhiteText = false }: SpeakerProps) {
    return (
        <div id="speaker-container"
            className="m-2 md:p-0 md:m-4 mb-0 w-[160px] h-[220px] md:w-[150px] lg:w-[220px] 2xl:w-[270px] 3xl:w-[320px] lg:h-[270px] 2xl:h-[320px] 3xl:h-[380px] flex flex-col justify-start items-center rounded-[100vw] group"
        >
            {link ? (
                <Link href={link} className="w-full h-full flex flex-col items-center justify-start pt-4">
                    ...
                    <div className="text-center min-h-[50px] mt-3 lg:mt-4 xl:mt-6 2xl:mt-8 3xl:mt-10 w-full max-w-[160px] md:max-w-[220px] 2xl:max-w-[270px] 3xl:max-w-[320px]">
                        <h3 className={`text-xs md:text-base lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl font-semibold font-GoodTimes ${isWhiteText ? 'text-white' : 'text-black'} leading-tight text-center overflow-wrap-anywhere`}>
                            {name}
                        </h3>
                ...
                <div className="w-full h-full flex flex-col items-center justify-start pt-4">
                    ...
                    <div 
                        className="text-center mt-3 lg:mt-4 xl:mt-6 2xl:mt-8 3xl:mt-10 max-w-[160px] md:max-w-[220px] 2xl:max-w-[270px] 3xl:max-w-[320px]"
                    >
                        <h3 className={`text-xs md:text-base lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl font-semibold font-GoodTimes ${isWhiteText ? 'text-white' : 'text-black'} leading-tight text-center overflow-wrap-anywhere`}>
                            {name}
                        </h3>
