...
export default function Hero() {
  return ( 
    <section id="hero-section" className="overflow-visible relative w-full">
      <div id="hero-container" className="flex flex-col gradient-1 h-[80vh] items-end justify-end lg:items-start lg:justify-center md:h-[90vmin] md:items-start md:justify-end md:pl-10 md:pr-10 min-h-[675px] mt-[-1px] overflow-hidden p-5 pb-[80px] lg:pb-40 relative rounded-bl-[2vmax] z-10">
