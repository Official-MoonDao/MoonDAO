export default function Hero() {
  return ( 
    <section className="overflow-visible relative w-full">
      <div className="HERO-CONTAINER flex flex-col gradient-1 h-[80vh] items-end justify-end lg:items-start lg:justify-center md:h-[90vmin] md:items-start md:justify-end md:pl-10 md:pr-10 min-h-[675px] mt-[-1px] overflow-hidden p-5 pb-[10vmax] lg:pb-40 relative rounded-bl-[2vmax] z-10">
        ...
        <h1 className="HEADER flex flex-col font-GoodTimes leading-none text-4xl">
          ...
          <p className="PARAGRAPH mr-5 max-w-[350px] pb-5 pt-2 text-lg w-full md:w-[100%] md:max-w-[350px] lg:max-w-[500px]">MoonDAO is accelerating our multiplanetary future with an open platform to fund, collaborate, and compete on challenges that get us closer to a lunar settlement.</p>
          <form className="FORM-CONTAINER flex flex-col items-center max-w-[500px] md:flex-row md:mt-5 pb-10 rounded-md w-full">
            ...
            <button className="BUTTON bg-white duration-500 focus:outline-none font-GoodTimes hover:pl-5 md:rounded-bl-0 px-4 py-2 rounded-bl-[10px] rounded-br-[10px] text-dark-cool w-full lg:bg-white" type="submit">Learn More</button>
          </form>
        </div>
      </div>
      <div className="WHITE-BLOCK absolute bg-white bottom-[-20px] hidden h-[40px] md:block right-0 w-[50%] z-10"></div>
    </section>
  )
}
