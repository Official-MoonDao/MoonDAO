...
export default function Hero(props: any) {
  ...
  return ( 
  <section>
      <div className="CALLOUT2-CONTAINER md:rounded-tl-[5vmax] overflow-hidden relative flex flex-col items-start justify-end md:items-start lg:items-start md:justify-end lg:justify-center gradient-4 pt-0 md:pt-[300px] lg:pt-[300px] p-5 pb-20 md:pr-10 md:pl-10 md:pb-20 lg:pb-40 min-h-[300px] lg:min-h-[600px]">
      ...
      <div className="CONTENT relative pt-[220px] md:pt-[0px] w-full pr-5 md:w-[70%] lg:w-[70%]]">
