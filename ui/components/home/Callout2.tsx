...
export default function Hero(props: any) {
  ...
  return ( 
    <div>
        <div className="CALLOUT2-CONTAINER md:rounded-tl-[5vmax] overflow-visible relative bg-white flex flex-col items-start justify-end md:items-start lg:items-start md:justify-end lg:justify-center gradient-4 p-5 pb-20 md:pr-10 md:pl-10 md:pb-20 lg:pb-40 min-h-[500px] md:h-[60vh] md:h-[90vmin]">
        <div className="BACKGROUND-ELEMENTS overflow-visible"> 
            ...
            <div className="BOTTOM-DIVIDER divider-4 absolute left-0 bottom-[-2px] w-[60%] h-full"></div>
        </div>
        <div className="CONTENT relative pt-0 w-full pr-5 md:w-[70%] lg:w-[70%]]">
            ...
            <p className="PARAGRAPH pt-2 pb-5 text-lg w-[130%] md:w-[100%] lg:max-w-[500px]">MoonDAO is a decentralized space program where space dreamers and serious builders unite</p>
