...
export default function Callout2() {
  return ( 
    <section>
        <div id="callout2-container" className="z-10 md:rounded-tl-[5vmax] relative flex flex-col items-end justify-end gradient-4 pt-0 lg:pt-5 p-5 pb-[10vmax] md:pr-10 md:pl-10 min-h-[250px] lg:min-h-[600px]">
          <div id="background-elements"> 
              ...
              <div id="featured-image" className="feature-3 absolute top-0 right-0 w-[80vmin] md:w-[70%] lg:w-[45vmax] mt-[-5vmax] h-full mt-5"></div>
          </div>
          <div id="content" className="relative pt-[220px] md:pt-20 md:pb-0 w-full pr-5 lg:w-[70%]">
              ...
              <Link href="https://app.moondao.com/join">
                <button id="button" className="rounded-br-[10px] px-4 py-2 bg-dark-cool lg:bg-dark-cool text-white font-GoodTimes hover:pl-5 duration-500 focus:outline-none " type="submit">Become A Member</button>
              </Link>
          </div>
        </div>
    </section>
