...
export default function Video() {
  ...
  // Fallback check for SDK readiness in case onLoad doesn't fire
  useEffect(() => {
  ...
  return (
    <section ref={sectionRef} id="video-section" className="relative bg-dark-cool">
      ...
      />
      <div id="video-container" className="w-full h-full max-w-[1920px] 2xl:max-w-[2560px] mx-auto">
        <div id="video-wrapper" className="w-full aspect-video relative z-40 group">
          <iframe
            ref={videoRef}
            id="video"
          ...
          <div className="absolute bottom-4 right-4 2xl:bottom-6 2xl:right-6 3xl:bottom-8 3xl:right-8 flex gap-2 2xl:gap-3 3xl:gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            >
              {isMuted ? (
                <svg
                  className="w-5 h-5 2xl:w-6 2xl:h-6 3xl:w-7 3xl:h-7"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
