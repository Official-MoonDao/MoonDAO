...
export default function ApplyModal({ type, setEnabled }: ApplyModalProps) {
  ...
  return (
    <Modal id="apply-modal-backdrop" setEnabled={setEnabled}>
      <div className="w-[98vw] sm:w-[95vw] md:w-[700px] flex flex-col gap-4 md:gap-6 p-2 sm:p-4 md:p-8 bg-gradient-to-b from-slate-800/90 to-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl md:rounded-[2vmax] shadow-2xl max-h-[90vh] md:max-h-[85vh]">
