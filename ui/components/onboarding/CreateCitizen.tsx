                      ...
                      if (mintedTokenId) {
                        ...
                        setTimeout(async () => {
                          await sendDiscordMessage(
                            ...
                            `[**${citizenName}** has just become a <@${DISCORD_CITIZEN_ROLE_ID}> of the Space Acceleration Network!](${DEPLOYED_ORIGIN}/citizen/${citizenPrettyLink}?_timestamp=123456789)`
                          )
