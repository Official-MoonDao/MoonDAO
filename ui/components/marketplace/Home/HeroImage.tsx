...
export default function HeroImage({ asset }: any) {
  ...
  return (
    <img
      className="w-[300px] hover:ring xl:hover:ring-4 ring-moon-orange transition-all duration-300 h-[362px] object-cover lg:w-[355px] xl:w-[400px] 2xl:w-[536px]  rounded-tl-[99px] rounded-br-[99px]"
