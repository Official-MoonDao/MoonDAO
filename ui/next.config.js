      ...
      return [
        {
          ...
          headers: [
            ...
            // Removed restrictive CORS policies to allow WebSocket connections
          ],
        },
        {
          source: '/(.*)',
